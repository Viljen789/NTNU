def sort(stack1, stack2, stack3):
    if stack1.empty() or stack1.peek() == stack1.pop():
        return stack1
    ...
    sort(stack2, stack1, stack3)
    sort(stack3, stack1, stack2)
...
# Example usage:
# Assuming stack1, stack2, and stack3 are instances of a Stack class with the required methods
# sorted_stack = sort(stack1, stack2, stack3)
# Example usage:
# Assuming stack1, stack2, and stack3 are instances of a Stack class with the required methods
# sorted_stack = sort_stack(stack1, stack2, stack3)
# Example usage:
# Assuming stack1, stack2, and stack3 are instances of a Stack class with the required methods
# sorted_stack = sort_stack(stack1, stack2, stack3)
