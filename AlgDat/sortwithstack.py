def sort(stack1, stack2, stack3):
    # Base case: If the stack is empty or contains only one element, it's already sorted
    if stack1.empty():
        return stack1
    ...
    # Partition elements into stack2 (smaller) and stack3 (larger)
    while not stack1.empty():
        if stack1.peek() < pivot:
            stack2.push(stack1.pop())
        else:
            stack3.push(stack1.pop())

    # Recursively sort stack2 and stack3
    sort(stack2, stack1, stack3)  # Use stack1 and stack3 as helpers for stack2
    sort(stack3, stack1, stack2)  # Use stack1 and stack2 as helpers for stack3

    # Merge sorted elements back into stack1
    while not stack2.empty():
        stack1.push(stack2.pop())
    stack1.push(pivot)  # Put the pivot back
